...
import { FileText, LayoutDashboard, Users, Upload, LogOut } from 'lucide-react'
      ...
      <aside className="w-60 flex-shrink-0 bg-slate-900 text-white flex flex-col">
        ...
        <div className="px-3 py-4 border-t border-slate-700/50">
          <div className="flex items-center gap-3 px-2 py-2 rounded-lg">
            <div className="w-8 h-8 rounded-full bg-slate-600 flex items-center justify-center text-sm font-bold">A</div>
            <div className="flex-1 min-w-0">
              <div className="text-xs font-medium text-white">Admin</div>
              <span className="text-xs px-1.5 py-0.5 rounded font-medium bg-red-100 text-red-700">admin</span>
            </div>
          </div>
        </div>
      </aside>
